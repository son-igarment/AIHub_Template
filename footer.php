  ...
  <div class="container">
    ...
    <div class="site-info">
      ...
      <span class="theme-info">
        <span>
          <?php printf( esc_html__( 'AIHub Template by Phạm Lê Ngọc Sơn - version %s', 'air-light' ), esc_attr( AIHUB_TEMPLATE_VERSION ) ); ?>.
        </span>
      </span>
    </div>
    <!-- ...up until here -->
...
<a
  ...
  data-version="<?php echo esc_attr( AIHUB_TEMPLATE_VERSION ); ?>"
>
